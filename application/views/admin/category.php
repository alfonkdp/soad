...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
    <?php echo strtoupper($action)?> Data Category
    </h1>
		<ol class="breadcrumb">
          ...
          <!-- Quick New Category -->
				<div class="box box-info" id="quick-category-box">
					...
					<div class="box-body">
						...
						<?php } else {?>
						<form action="<?php echo site_url().'admin/'.$cat.'/update/';?><?php echo !empty($category) ? $category->category_id : "";?>" class="form-horizontal"  method="post">
						<?php  } ?>
