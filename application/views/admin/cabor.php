<head>
        ...
        <script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>assets/js/jquery-1.11.2.min.js"></script>
        ...
        <script type="text/javascript" language="javascript" >
            $(document).ready(function() {
                var dataTable = $('#employee-grid').DataTable( {
                    ...
                    "serverSide": true,
                    "ajax":{
                        url :'<?php echo site_url('atlet/get_data'); ?>', // json datasource
